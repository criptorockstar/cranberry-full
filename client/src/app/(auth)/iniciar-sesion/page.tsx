  ...
  return (
    <React.Fragment>
      <div className="bg-[#f0f0f0">
        <div className="w-full pt-4 pb-2 lg:hidden xs:block z-20">
        ...
        <div className="flex lg:min-h-screen xs:min-h-[calc(100vh - 60px)]">
          ...
          <div
            className={`flex flex-col justify-center py-6 xs:py-0 xs:pb-3 rounded-2xl 
            mx-auto px-4 
            lg:min-w-[400px] max-w-[650px]
            lg:w-full lg:mx-0 h-screen
        `}>
